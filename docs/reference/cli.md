...
</dd><dt id="by-transpile--in-place"><a href="#by-transpile--in-place"><code>--in-place</code></a>, <code>-i</code></dt><dd><p>overwrite the source file with its Python output</p>
